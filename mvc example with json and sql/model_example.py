...
def open_firebase():
    # cred = credentials.Certificate("/Users/dan/Desktop/Python/mvc example with json and sql/mvc-example-firebase.json")
    cred = credentials.Certificate("/Users/dan/Desktop/Python/mvc example with json and sql/first-project-9aa06-firebase-adminsdk-docyw-bfe821b1c3.json")
    # firebase_admin.initialize_app(cred, {
    #     'projectId': 'mvc-example-85de8',
    # })
    firebase_admin.initialize_app(cred, {
        'projectId': 'first-project-9aa06',
    })
...
class Person(object):
    ...
    def getAllFirestore(self):
        ...
        return result
    @classmethod
    def addNewFirestore(self, last_name, first_name , phone):
        db = open_firebase()
        person_ref = db.collection(u'person')
